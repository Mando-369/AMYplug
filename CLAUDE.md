...
- **`docs/TESTS.md` says what each of the 84 tests covers and why.** Read it to pick the
...
- **Before tagging a release, run `docs/TEST_PROTOCOL.md`.** It lists what the 84 automated
